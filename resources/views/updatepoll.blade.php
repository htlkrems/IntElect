              ...
              <div class="row">
                  <div class="col s12 m12 l6">
                      <div class="row">
                          ...
                          <div class="col s12">
                  					<h5 class="col s1">Von</h5> <input placeholder="Datum" type="text" class="datepicker col s5 tovalidate" style="font-size: 20px" name="pollbegin" required value="{{ substr($poll->begin, 0, 10) }}"> <h5 class="col s1">um</h5> <input placeholder="Uhrzeit" type="text" class="timepicker col s5" name="pollbegintime" style="font-size: 20px" required value="{{ substr($poll->begin, 11, 8) }}">
                  				</div>
                  				<div class="col s12">
